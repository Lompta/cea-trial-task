...
INSERT into UserDonation (UserDonationId, UserId, Amount, DonatedDate, DonationOrg) VALUES (3, 2, 1000, "2017-1-7", "MIRI");

INSERT into UserDonation (UserDonationId, UserId, Amount, DonatedDate, DonationOrg) VALUES (4, 2, 4000, "2017-5-14", "ACE");

-- The inactive user has not made any donations this year.
